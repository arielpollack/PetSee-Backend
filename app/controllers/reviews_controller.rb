class ReviewsController < ApplicationController
  ...
  def create
    ...
    if @review.nil?  # New review
      ...
      render_error "You have already written a review about this user" and return
    end
      if @review.save
  ...
  def update_existing_review
    ...
    render_error "You are not the writer of this review" and return if not @review.writer_id == @current_user.id
    render_error "There is no review of this number" and return if @review.nil?
